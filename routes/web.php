...
use App\Http\Controllers\RealidadAumentadaController;
...
Route::controller(UsuarioController::class)->middleware('auth')->group(function () {
  ...
  Route::delete('/eliminar_usuario/{id}', 'eliminar_usuario')->name('eliminar_usuario');
});

Route::controller(EstudianteController::class)->middleware('auth')->group(function () {
  Route::get('/estudiantes', 'estudiantes')->name('estudiantes');
  Route::delete('/eliminar_estudiante/{id}', 'eliminar_estudiante')->name('eliminar_estudiante');
  Route::post('/crear_estudiante', 'crear_estudiante')->name('crear_estudiante');
  Route::put('/estudiante/actualizar/{id}', 'update')->name('actualizar_estudiante');
});

Route::resource('/roles', RolController::class)->names('roles');
Route::controller(ActividadController::class)->middleware('auth')->group(function () {
  Route::get('/estructura_curso', 'estructura_curso')->name('estructura_curso');
  Route::get('/actividades',  'actividades')->name('actividades');
});

Route::controller(ModeloController::class)->middleware('auth')->group(function () {
  Route::get('/craneo', 'craneo')->name('craneo');
  Route::get('/vista_organos_internos', 'vista_organos_internos')->name('vista_organos_internos');
  Route::get('/vista_ojo_humano', 'vista_ojo_humano')->name('vista_ojo_humano');
  Route::get('/vista_craneo', 'vista_craneo')->name('vista_craneo');
  Route::get('/vista_esqueleto', 'vista_esqueleto')->name('vista_esqueleto');
});

Route::controller(RealidadAumentadaController::class)->middleware('auth')->group(function () {
  Route::get('/RAcraneo', 'RAcraneo')->name('RAcraneo');
});

Route::controller(LeccionController::class)->middleware('auth')->group(function () {
  Route::get('/leccion1', 'leccion1')->name('leccion1');
});

Route::controller(TallerController::class)->middleware('auth')->group(function () {
  Route::get('/taller', 'vista_taller')->name('taller');
});
