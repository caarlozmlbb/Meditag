...
<head>
    ...
    <div class="relative min-h-screen flex ">
        <div
            ...
            <div class="sm:w-1/2 xl:w-3/5 h-full hidden md:flex flex-auto items-center justify-center p-10 overflow-hidden bg-purple-900 text-white bg-no-repeat bg-cover relative"
                style="background-image: url(https://digital55.com/wp-content/uploads/2022/01/futuro_realidad_aumentada_empresas-1.jpg);">
                <div class="absolute bg-gradient-to-b from-green-600 to-lime-500 opacity-75 inset-0 z-0"></div>
                <div class="w-full  max-w-md z-10">
                    <div class="sm:text-4xl xl:text-5xl font-bold leading-tight mb-6">Explora el aprendizaje con
                        Realidad Aumentada.</div>
                    {{-- <model-viewer src="{{ asset('assets/models3D/craneoMovimiento.glb') }}" alt="Modelo 3D" auto-rotate
                        camera-controls style="width: 100%; height: 300px; margin: 0 auto;">
                    </model-viewer> --}}
                    ...
                    {{-- <model-viewer
    src="{{ asset('assets/models3D/craneoMovimiento.glb') }}"
    alt="Modelo 3D"
    auto-rotate
    camera-controls
    exposure="0.8"
    ...
    style="width: 100%; height: 300px; margin: 0 auto; background-color: #f0f0f0;">
</model-viewer> --}}
            ...
            <div
                ...
                <div class="max-w-md w-full space-y-8">
                    <div class="text-center">
                        <img src="{{ URL::asset('/assets/img/armediOff.png') }}" alt="10" height="">
                    ...
                    <form class="mt-8 space-y-6" action="{{ route('login') }}" method="POST">
                        ...
                        <div class="mt-8 content-center">
                            ...
                            <input type="password"
                                ...
                                @error('password') is-invalid @enderror" name="password" id="userpassword"
                     ...
                     --}}
                        <div class="flex items-center justify-center space-x-2">
                            ...
                            <span class="text-center text-gray-300 font-normal">© IIIS.<br> Developed by
                                <b><a href="https://themesbrand.com/" target="_blank" class="text-reset">Carloz</a></b>
                            </span>
                            <span class="h-px w-16 bg-gray-200"></span>
                            {{-- Mini-texto
