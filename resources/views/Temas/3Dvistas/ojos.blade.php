...
@section('content')
    ...
    <div class="container my-4">
        <div class="rounded border p-3 shadow-sm bg-white">
            <!-- Visor del modelo 3D -->
            <model-viewer src="{{ asset('assets/models3D/ojo_glb.glb') }}" alt="👁️ Modelo 3D del Ojo Humano" auto-rotate
...
{{-- <script>
        ...
        window.addEventListener('DOMContentLoaded', () => {
            ...
            // Cuando el modelo esté cargado, podemos acceder a los botones
            modelViewer.addEventListener('load', () => {
                const shadowRoot = modelViewer.shadowRoot;

                // Seleccionamos los hotspots dentro del model-viewer
                ...
                botones.forEach(btn => {
                    btn.addEventListener('click', () => {
                        ...
                        document.getElementById('descripcion-hotspot').textContent =
                            descripcion;
                    });
                });
            });
